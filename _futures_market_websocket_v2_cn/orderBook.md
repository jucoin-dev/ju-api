...
content_markdown: |-
        **如何正确在本地维护一个orderbook副本**
        ...
        1.订阅 wss://fstream.ju.com/ws/market，depth_update@btc_usdt


        2.开始缓存收到的更新。同一个价位，后收到的更新覆盖前面的。


        3.访问Rest接口 https://fapi(或dapi).ju.com/future/market/v1/public/q/depth?symbol=btc_usdt&level=500 获得一个500档的深度快照
